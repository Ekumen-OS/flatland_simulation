...
## Contributing to Flatland Simulation

The following is a set of guidelines for contributing to Flatland Simulation project.
...
* **Which version of Flatland Simulation are you using?**?
...
* **Perform a** [cursory search](https://github.com/Ekumen-OS/flatland_simulation/issues) to see if the enhancement has already been suggested. If it has, add a comment to the existing issue instead of opening a new one.
...
* **Specify which version of Flatland Simulation you're using.**
...
#. **Fork the Flatland Simulation package** you want to contribute to. This will create
...
All Flatland Simulation team members actively:

* **Watch** all Flatland Simulation-related repositories to receive email notifications of new issues / pull requests
